...
if __name__ == "__main__":
    ...
    X_train_array, X_test_array, _ = data_transform.initiate_transformation(train_data, test_data)



    model_trainer = Modeltrainer()
    model_trainer.inititate_model_training(X_train_array,X_test_array)
